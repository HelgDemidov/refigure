...
4b. **Перенос VLM-слоя — 25%, самая тяжёлая стадия.** LibreOffice+облачная
   ...
   `figures_vlm.py` (676 строк) в исходном пайплайне — самый связанный с ним модуль
...
**Итого фазы I-II: 10+15+5+8+25+15+8+4+9+5 = 104%.** Пул вырос с исходных
100% (оценка 2026-08-04) до 104% пунктом 6b, добавленным 2026-08-05 по
итогам рыночного чек-апа CLI-ландшафта (3% на момент добавления, 4% после
того же дня разбора трёх конкурентов расширил скоуп до batch-режима) —
расширение скоупа задним числом, не пересчёт уже пройденной методологии;
проценты первых 9 пунктов не трогались.
